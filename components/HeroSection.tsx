  ...
  return (
    <section className="bg-background pt-10 pb-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        {/* Main Hero Container */}
        <div className="relative rounded-sm overflow-hidden min-h-[500px] md:min-h-[600px] flex items-center border border-surface-light">
          {/* Background Image - Industrial aesthetic */}
          <div className="absolute inset-0 z-0">
            <Image
              src="https://images.unsplash.com/photo-1565515267688-6627d31065ce?auto=format&fit=crop&q=80&w=2000"
          ...
          <div className="relative z-10 w-full px-8 md:px-16 py-12">
            <motion.div
              ...
              className="max-w-3xl"
            >
              <span className="inline-block bg-surface border border-surface-light text-accent text-[10px] font-bold uppercase tracking-[0.2em] px-4 py-1.5 rounded-sm mb-6">
                B2B Signage & Printing Partner
              </span>
              
              <h1 className="text-text font-heading text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6">
                Industrial Grade <br />
                <span className="text-accent">Branding Solutions</span>
              </h1>
              
              <p className="text-text-muted text-lg md:text-xl font-normal leading-relaxed mb-10 max-w-2xl">
                We manufacture premium 3D letters, ACP signage, and flex printing for enterprises. Precision engineering meets rapid deployment.
              </p>

              <div className="flex flex-col sm:flex-row items-center gap-4">
                <Link
                  href="/contact"
                  className="w-full sm:w-auto bg-accent text-background px-8 py-4 rounded-sm text-sm font-bold uppercase tracking-widest hover:bg-accent-dark transition-all shadow-lg shadow-accent/20 flex items-center justify-center gap-2"
                >
                  Request a Quote
