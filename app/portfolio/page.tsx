...
export default function PortfolioPage() {
  return (
    <div className="pt-24">
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-20 pb-10 flex flex-col items-center text-center">
        <p className="text-accent text-[10px] tracking-[0.5em] uppercase font-black mb-4">Our Work</p>
        <h1 className="text-text font-serif text-5xl md:text-7xl font-bold leading-tight mb-6">
          Premium <span className="text-[#0099D4] italic">Portfolio</span>
        </h1>
        <p className="text-text-muted max-w-2xl text-sm leading-relaxed mb-4 mx-auto">
      ...
      <section className="py-20 border-t border-surface-light">
